...
async function createCard(company) {
  ...
  const sector = categories.filter(
...
export function handleCreateDepModal() {
  ...
  buttonCreate.addEventListener("click", async () => {
    ...
    const inputDepDescription = document.querySelector(
  ...
  employees.forEach((element) => {
    if (element.company_id == null) {
      ...
      removeButtonEmp.addEventListener("click", () => {
        ...
        const buttonCloseDeleteUser = document.querySelector(
          "#button__close-delete-user"
        );
      ...
      editButtonEmp.addEventListener("click", () => {
        ...
        const buttonCloseEditUser = document.querySelector(
          "#button__close-edit-user"
        );
        ...
        const buttonSaveEditUser = document.querySelector(
      ...
      const getCompanyName = companies.filter(
